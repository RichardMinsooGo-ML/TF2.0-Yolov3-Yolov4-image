...
YOLO_V3_WEIGHTS             = "./darknet_weights/yolov3.weights"
YOLO_V3_TINY_WEIGHTS        = "./darknet_weights/yolov3-tiny.weights"
YOLO_V4_WEIGHTS             = "./darknet_weights/yolov4.weights"
YOLO_V4_TINY_WEIGHTS        = "./darknet_weights/yolov4-tiny.weights"
...
if dataset_name == "mnist":
    ...
    if YOLO_TYPE == "yolov3":
        TRAIN_CHECKPOINTS_FOLDER    = "./checkpoints/yolo_v3_mnist"
        DATA_TYPE = "yolo_v3_mnist"
    elif YOLO_TYPE == "yolov4":
        TRAIN_CHECKPOINTS_FOLDER    = "./checkpoints/yolo_v4_mnist"
    ...
    if YOLO_TYPE == "yolov3":
        TRAIN_CHECKPOINTS_FOLDER    = "./checkpoints/yolo_v3_fashion_mnist"
        DATA_TYPE = "yolo_v3_fashion_mnist"
    elif YOLO_TYPE == "yolov4":
        TRAIN_CHECKPOINTS_FOLDER    = "./checkpoints/yolo_v4_fashion_mnist"
